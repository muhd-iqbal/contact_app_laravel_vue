          ...
          <div
            ...
            <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
              <form>
                ...
                <div class="flex flex-wrap">
                  <InputField name="Allocation (%)" placeholder="Needs - Wants - Savings" v-model="allocation" />
...
onMounted(async () => {
  ...
  switch (response.status) {
    case 200:
      ...
      console.log(data);
      const [user] = data.filter((item: any) => item.name == "username");
      if(user != undefined) {
        username.value = user.value;
      }

      
      //find value with name = username
